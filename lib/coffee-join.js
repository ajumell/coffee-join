...
(function() {
  var SourceMapConsumer, SourceMapGenerator, basename, coffeeScript, colors, compile, concat_files, dirname, join, print, process_files, re_order_source_map, read, ref, ref1, relative, write;

  coffeeScript = require("coffee-script");

  ref = require("./utils"), print = ref.print, relative = ref.relative, dirname = ref.dirname, read = ref.read, write = ref.write, basename = ref.basename, join = ref.join;
  ...
  process_files = function(files, output) {
    var base, code, dir, line_number_mapping, map, out_js_file, out_map_file, ref2, ref3, sourceMap;
    dir = dirname(output);
